...
"$javac_bin" --release 17 -d "$project_dir/build/checks" \
  ...
  "$project_dir/app/src/main/java/com/pocketparadox/game/BoardMotion.java" \
  "$project_dir/tests/EngineCheck.java" "$project_dir/tests/LevelCheck.java" "$project_dir/tests/MotionCheck.java"
...
"$java_bin" -ea -cp "$project_dir/build/checks" com.pocketparadox.game.MotionCheck
